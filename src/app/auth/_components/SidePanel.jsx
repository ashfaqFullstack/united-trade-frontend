...
export default function SidePanel({ mode }) {
    ...
    return (
        <div className="relative flex h-full flex-col justify-between overflow-hidden rounded-l-3xl bg-gradient-to-br from-indigo-600 via-indigo-600 to-purple-600 p-10 text-white">
