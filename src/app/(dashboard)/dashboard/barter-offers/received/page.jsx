...
import { useReceivedBarterOffers } from '@/hooks/useBarter';
import BarterOfferCard from '@/components/barter/BarteOfferCard';

const TABS = ['All', 'Pending', 'Accepted', 'Rejected', 'Cancelled'];

export default function ReceivedBarterOffersPage() {
    const [tab, setTab] = useState('All');
    const { data: offers, isLoading } = useReceivedBarterOffers();
    ...
    return (
        <div className="space-y-5">
            <div>
                <h2 className="text-lg font-bold text-slate-900">Received Barter Offers</h2>
                <p className="text-sm text-slate-500">Offers you've received from other users</p>
            </div>
